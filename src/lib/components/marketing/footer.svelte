...
<footer class="container max-w-4xl pt-16">
  ...
  <div
    class="not-typography flex flex-col items-center border-t border-border/50 py-4 text-sm text-muted-foreground sm:flex-row sm:justify-between">
