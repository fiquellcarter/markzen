...
<div class="marketing-typography">
  <header class="absolute top-4 left-1/2 container max-w-4xl -translate-x-1/2">
    <nav class="flex min-h-14 w-full items-center rounded-2xl border px-4 py-2">
      ...
      <div class="inline-flex w-1/2 items-center justify-end gap-4">
        <Button
          href="https://github.com/fiquellcarter/markzen"
          target="_blank"
  ...
  <footer class="container max-w-4xl pt-16">
    <div class="mb-16 flex flex-col justify-between gap-12 sm:flex-row sm:gap-24">
    ...
    <div
      class="flex flex-col border-t py-4 text-sm text-muted-foreground sm:flex-row md:items-center md:justify-between">
